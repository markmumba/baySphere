        ...
        <>
            <div id="about" className=" py-10  lg:py-28">
                ...
                <div className=' grid  md:flex lg:space-x-40 lg:px-60  '>
                    <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 2 }} animate={{ y: -20 }} className='mt-20 p-7 lg:p-20 font-medium  text-gray-500 md:text-2xl text-xl max-w-md lg:max-w-3xl'>
                ...
                <div className='grid  md:flex lg:space-x-40 lg:px-60'>
                    ...
                    <motion.div initial={{opacity:0}} whileInView={{opacity:1}} transition={{duration:2}} animate={{y:-20}}  className='p-7 lg:p-20 font-medium text-gray-500 md:text-2xl text-xl max-w-md lg:max-w-3xl'>
