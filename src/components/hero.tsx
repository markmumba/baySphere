    ...
    return (
        <>
            ...
            <div className=' pt-20 md:pt-40 absolute inset-0 flex justify-center -z-10 '>
                <motion.div initial={{opacity:0}} animate={{opacity:0.2}} transition={{duration:2}} className=" w-[320px] h-[320px]   md:w-[720px] md:h-[720px] rounded-full opacity-20 blur-3xl bg-black "></motion.div>
            </div>
            <div className=" pt-20 grid lg:flex lg:space-x-10">
                ...
                <motion.div animate={{ y: -50 }} transition={{ duration: 1 }} className=' px-4 lg:pt-10'>
