    ...
    return (
        <>
            <div id="services" className="pt-[-10rem]">
                <h1 className="text-center font-bold  text-2xl md:text-5xl">What we do</h1>
                <p className="text-center text-sm md:text-xl font-medium px-4 py-3 md:px-60 md:py-10 ">Our team creates customized strategies tailored
                ...
                <div className="grid md:flex justify-center py-10 gap-7">
                    <div className="border border-gray-200 rounded-lg max-w-sm p-7 shadow-lg">
